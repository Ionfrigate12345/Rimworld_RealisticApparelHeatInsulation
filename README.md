...
其他一些因素（如湿度、气候和天气的影响、裸露身体部位）也会对耐热性产生影响。

在原版游戏中，角色穿的衣物越多，最高舒适温度（MaxCT）就越高。即使在 50°C 的热浪中穿着风雪大衣也没有任何抗热惩罚。这显然过于违和。
...
- 大多数服装属于非隔热服装。
- 原版中增加抗热的服装，现在大多会减少抗热。
- 原版中抗热越高越大的服装，现在反而抗热惩罚越大，因为如今抗热惩罚基础值是原版抗热奖励的某个百分比。
- 如果服装的原版抗热属性低于抗寒属性，则使用抗寒属性值进行计算。
- 一些服装有双倍抗热惩罚，例如风雪大衣和儿童风雪大衣。
- VE服饰拓展中的手套和鞋子只有一半的抗热惩罚。
- 对于5-10公斤的衣物，每超出1公斤会带来0.2°C的抗热惩罚。
- 对于超过10公斤的衣物，每超出1公斤会带来0.5°C的抗热惩罚。
- 一些基础服装没有基础抗热惩罚：衬衫、裤子、胸衣、部落服、儿童部落服。
- VE服饰拓展的一些基础服装也同样没有基础抗热惩罚：休闲T恤、短裤、短裙。
- 基础服装在潮湿气候或天气中依然有湿度惩罚。
- 凤凰甲保留其原版隔热加成。
- 拥有SOS2的EVA抗泄压属性的服装同样不受影响。例如Eccentric Tech的天使服、古代机甲护甲等。注意本功能无需安装SOS2，仅取决于模组作者是否在ThingDef中定义了SOS2抗泄压属性。

对于隔热服装：

当前有 4 种隔热服装：防尘衣、牛仔帽、遮阳帽、连帽帽。

在干燥气候中（如沙漠、干燥灌木林）且无雨时，这些隔热衣服的抗热奖励会大幅增加。否则其效果与非隔热服装相同。


3. 服装重量：

如果角色穿戴的服装总重量达到其携带能力的某一比例，则会进一步产生额外的抗热惩罚。


4. 基因：

生物DLC中的耐热基因/超级耐热基因额外提供 +5°C/+10°C 抗热加成。


5. 暴露的身体部位：

- 某些身体部位未被任何衣物覆盖时，会有额外的抗热奖励。
- 裸体主义者特性现在会有一定优势。
- 一些不覆盖手臂或肩膀的衣物就和现实中的短袖一样，在炎热天气中更有用。
- 小人如果穿着VE服饰拓展中的短裤或短裙，在没有其它衣物覆盖腿部时会被本模组视为裸露腿部，依然有对应的抗热加成奖励。
...
- 对于非基础型的夏季衣服，如今需要避免无脑堆传奇级和高等材料，因为高品质和高级材料反而会增加抗热惩罚。
- 凤凰甲在炎热天气中的战斗中更重要了。
- 耐热基因也比原版更有用了。
